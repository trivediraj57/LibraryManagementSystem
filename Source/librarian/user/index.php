		...
		<div class="container">
			<div class="row">
				...
				<div class="header-right">
					<ul>
						<li class="dropdown"><a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="fas fa-user" aria-hidden="true"> Login</i></a>
						...
						<li><a href="contactus.php"><i class="fa fa-phone" aria-hidden="true">  Contact Us</i></a></li>
					</ul>		
				</div>
			</div>
		</div>
		...
		<div class="slide-carousel owl-carousel">
			<div class="item" style="background-image:url(dist/img/2.jpg);">
				...
				<div class="text">
					...
					<div class="this-item">
						<h3>We are not Luxury yet a<b style="color:#69ba4e"> NECESSITY !</b></h3>
					</div>
					<div class="this-item">
